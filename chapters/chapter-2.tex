...
A simplified color-singlet vector particle model \citep{theory:ttZp,theory:ttZp_LHC} is employed tin the search. The interaction Lagrangian assumes only $Z'$ to top coupling and has the form
\begin{equation}
\begin{aligned}
