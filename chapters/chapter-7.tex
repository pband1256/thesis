...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.9\linewidth]{fig/SRunblinded/mZp2000_PieChart_postFit.png}
...
\centering
\subfloat[]{
\includegraphics[width=0.45\linewidth]{fig/SRunblinded/mZp2000/Plots/SR_HT_all.png}}
\subfloat[]{
\includegraphics[width=0.45\linewidth]{fig/SRunblinded/mZp2000/Plots/SR_nJets.png}}

\subfloat[]{
\includegraphics[width=0.45\linewidth]{fig/SRunblinded/mZp2000/Plots/SR_nBJets.png}}
\subfloat[]{
\includegraphics[width=0.45\linewidth]{fig/SRunblinded/mZp2000/Plots/SR_lepton_0_pt.png}}
\caption[Caption]{\label{fig:ana:signal_prefit}Pre-fit kinematic distributions and event compositions for several observables in the inclusive \acs{SR}. The shaded band represents the uncertainty in the total distribution. The first and last bins of each distribution contains underflow and overflow events respectively.}
\end{figure}
