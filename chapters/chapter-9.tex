...
\centering
\subfloat[\CRttWm]{
\includegraphics[width=0.315\linewidth]{fig/SRunblinded/CRttW2l_minus_nJets_postFit.png}}
\subfloat[\CRttWp]{
\includegraphics[width=0.315\linewidth]{fig/SRunblinded/CRttW2l_plus_nJets_postFit.png}}
\subfloat[\CRonebm]{
\includegraphics[width=0.315\linewidth]{fig/SRunblinded/CR1bminus_nJets_postFit.png}}

\subfloat[\CRonebp]{
\includegraphics[width=0.315\linewidth]{fig/SRunblinded/CR1bplus_nJets_postFit.png}}
\subfloat[CR HF $e$]{
\includegraphics[width=0.315\linewidth]{fig/SRunblinded/CR1b3le_lep_2_pt_postFit.png}}
\subfloat[CR HF $\mu$]{
\includegraphics[width=0.315\linewidth]{fig/SRunblinded/CR1b3lm_lep_2_pt_postFit.png}}

\subfloat[CR Mat. Conv]{
\includegraphics[width=0.315\linewidth]{fig/SRunblinded/CRttbarCO2l_CO_1_postFit.png}}
\subfloat[CR Low $m_{\gamma^*}$]{
\includegraphics[width=0.315
\linewidth]{fig/SRunblinded/CRttbarCO2l_gstr_1_postFit.png}}
