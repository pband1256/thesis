...
\usepackage{url}
\urlstyle{same}
%\usepackage[backend=bibtex,style=numeric-comp,bibencoding=utf8,natbib=true,sorting=none,backref]{biblatex}
...
\begin{enumerate}
\item Finish adding bullets for all sections \dotfill 06/04
	\begin{itemize} Remaining
	\item introduction
	\end{itemize}
\item Fill in details \dotfill 06/13
	\begin{itemize}
...
\item Submission to the graduate school \dotfill 07/01
\item Defense \dotfill 07/15
\end{enumerate}
