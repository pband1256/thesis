...
\author{Your Name Here} %% Put your name in full as it is officially recognized by Michigan State University here.
\title{Exciting Dissertation Title} %% Put the title of your dissertation here.
...
\chapter{Fission Observables}
\label{chapter:tunneling}
\subfile{chapters/chapter-3}

\chapter{Multimodal Fission}
\label{chapter:multimodal}
\subfile{chapters/chapter-4}

\chapter{Fission Emulators}
\label{chapter:emulators}
